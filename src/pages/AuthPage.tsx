...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-brand-950 via-slate-900 to-slate-950">
      ...
      {/* Right Panel - Google Only Sign In & Role Selector */}
