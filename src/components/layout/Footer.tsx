        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              {['Find Hostel', 'Find Flat', 'Mess Services', 'Roommate Finder'].map(item => (
                <li key={item}>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              {['List Property', 'Register Mess', 'Owner Dashboard', 'Analytics', 'Pricing'].map(item => (
                <li key={item}>
          ...
          <div className="col-span-2 md:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+918999295362" className="hover:text-white transition-colors tracking-wide">+91 8999295362 / 7517807405</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-brand-400 flex-shrink-0" />
                <a href="mailto:support.flatsnfoods@gmail.com" className="hover:text-white transition-colors">support.flatsnfoods@gmail.com</a>
              </li>
            </ul>
            <div className="mt-6">
              <h5 className="text-white text-sm font-semibold mb-2">Download App</h5>
              <div className="flex gap-2">
                <div onClick={() => alert('Coming soon!')} className="px-3 py-1.5 rounded-lg bg-slate-800 text-xs flex items-center gap-1.5 hover:bg-slate-700 cursor-pointer transition-colors">
                  <span>📱</span> App Store
                </div>
                <div onClick={() => alert('Coming soon!')} className="px-3 py-1.5 rounded-lg bg-slate-800 text-xs flex items-center gap-1.5 hover:bg-slate-700 cursor-pointer transition-colors">
